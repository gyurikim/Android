...
public class ContactAdapter extends BaseAdapter {
    ...
    @Override
    public View getView(int i, View view, ViewGroup viewGroup) {    //ListViewdptj getView()메소드를 통해서 cellView의 정보를 얻어온다
        if(view==null){//만일 view가 널이면
            //레이아웃을 전개해서 cellView 객체를 만든다.
