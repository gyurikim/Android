...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        //GET 방식 http 요청을 해서 결과 문자열을 읽어와서 : other 스레드에서 작업 > GET방식요청을 해주는 asyncTask를 활용하기
        GetRequestTask task=new GetRequestTask();
        task.execute(urlAddr);
        //console(EditText)에 출력하기 : UI 스레드에서 작업
    }
    ...
    public class GetRequestTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            //결과데이터를 (문자열)리턴해주면 onPostExecute(s)에 값이 리턴된다
